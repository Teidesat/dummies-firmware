...
- Base mas solida para siguientes pasos de migracion (colas, event groups y separacion de tareas por rol).

## Alcance de esta fase
Esta fase no cambia el protocolo de red ni la logica funcional principal de envio. El objetivo fue estabilizar sincronizacion y temporizacion.

## Siguientes pasos recomendados
1. Aplicar el mismo criterio al receiver para homogeneidad entre ambos firmwares.
2. Reemplazar buffer/contador compartidos por Queue o StreamBuffer de FreeRTOS donde corresponda.
3. Introducir EventGroup para estado de conectividad WiFi y transiciones de estado del firmware.
4. Validar en hardware con prueba de carga y reconexion para confirmar ausencia de deadlocks.
